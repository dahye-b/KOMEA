			...
			if(!data.isLogin){
				...
				if(data.ssbyp == "3"){
					if(data.preReq){
						...
						document.Form.action = "<c:url value='/show/InfoCenter/BiddingRequestWrite.do'/>";
						document.Form.submit();
					}
				}else{
            ...
            <div class="row">
            	...
            	<div class="section-text col-12 mb-100 bo-v">
					...
					<div class="border-top-1">
						<h4 class="text-bold text-info mt-10 pl-10" >${EventNm}</h4>
					</div>
				    ...
				    <div class="mt-10" >
				        <div class="btn-group btn-group-justified float-right">
				            <a href="javascript:fn_List();" class="btn btn-sm btn-secondary" >목록</a>
				            <c:if test="${loginInfo.ssbyp eq '3'}">
