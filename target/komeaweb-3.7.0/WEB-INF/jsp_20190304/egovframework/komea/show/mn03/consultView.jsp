...
function fn_PreEvent(){
	if(document.Form.preCnsltexhbCd.value == undefined ||  document.Form.preCnsltexhbCd.value == ""){
			...
			if(!data.isLogin){
				...
				if(data.ssbyp == "2"){
					if(data.preReq){
						...
						document.Form.action = "<c:url value='/show/ConsultWrite.do'/>";
						document.Form.submit();
					}
				}else{
...
<form:input type="hidden" name="gubun" path="gubun" id="gubun" value="1"/>
...
<form:input type="hidden" path="cnsltexhbCd" name="cnsltexhbCd" id="cnsltexhbCd" value="${CnsltexhbRegistInfo.cnsltexhbCd}"/>
<form:input type="hidden" path="preCnsltexhbCd" name="preCnsltexhbCd" id="preCnsltexhbCd" value="${CnsltexhbRegistInfo.preCnsltexhbCd}"/>
<form:input type="hidden" name="insttMberCd" path="insttMberCd" id="insttMberCd" value="${CnsltexhbRegistInfo.insttMberCd}"/>
            ...
            <div class="row">
            	...
            	<div class="section-text col-12 mb-100 bo-v show">
				    ...
				    <div class="text-right" >
				    	...
				    	<c:if test="${CnsltexhbRegistInfo.progrsSttus eq '1'}">
							<a href="javascript:fn_Inert('${ViewGb}','${CnsltexhbRegistInfo.cnsltexhbCd}');" class="btn btn-sm btn-warning" role="button">신청하기</a>
						</c:if>
						<!--<a href="javascript:fn_BuyerInert('${CnsltexhbRegistInfo.cnsltexhbCd}');" class="btn btn-sm btn-warning" role="button">바이어등록</a>-->
				        <a href="<c:url value='/show/ConsultList.do'/>" class="btn btn-sm btn-secondary" role="button">목록</a>
				    </div>
				    <!-- } 버튼 끝 -->
				</div>
            </div>
