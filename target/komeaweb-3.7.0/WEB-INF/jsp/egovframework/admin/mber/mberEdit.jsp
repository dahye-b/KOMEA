...
function fn_uodate(){
	document.Form.action = "<c:url value='/admin/UpdateMber.do'/>";
...
<div class="container_fluid">
	...
	<form:form name="Form" commandName="mber" method="post" modelAttribute="mber"> <!-- enctype="multipart/form-data" -->
	<form:input type="hidden" path="insertUserId" name="insertUserId" id="insertUserId" value="${loginInfo.id}"/>
	
		<div class="page-header"> 
			<h3>회원관리<small>수정</small></h3>
		</div>
			...
			<table class="table table-bordered table-sm" >
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<form:input type="text" class="form-control" path="cmpnyNm" name="cmpnyNm" id="cmpnyNm" value="" maxlength="100"/>
							<form:input type="text" class="form-control" path="cmpnyNmEng" name="cmpnyNmEng" id="cmpnyNmEng" value="" maxlength="100"/>
						</td>
						<th>
