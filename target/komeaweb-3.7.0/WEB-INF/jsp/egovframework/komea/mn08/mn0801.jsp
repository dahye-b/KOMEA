            	...
            	<div class="section-text col-12 mb-100">
					...
					<div class="card" id="ststs-1">
						<div class="card-header state-header">
							<h3 class="text-center">Status of Members</h3>
						</div>
						<div class="card-body">
					...
					<div class="card collapse" id="ststs-2">
						<div class="card-header state-header">
							<h3 class="text-center">Product & Supply</h3>
						</div>
						<div class="card-body">
							<p class="card-text text-center">
					...
					<div class="card collapse" id="ststs-3">
						<div class="card-header state-header">
							<h3 class="text-center">Direct exports</h3>
						</div>
						<div class="card-body">
							<p class="card-text text-center">
					...
					<div class="card collapse" id="ststs-4">
						<div class="card-header state-header">
							<h3 class="text-center">Status and Statistics</h3>
						</div>
						<div class="card-body">
							<p class="card-text text-center">
...
$( document ).ready(function() {
		...
		$(".nav-link").on('click', function(){
			...
			if (id=="nav-tab-1") {
					...
					$('.btn-ststs[data-id="1"]').addClass("active");

					$("#ststs-1").show();						
			} else if (id=="nav-tab-2") {
					$(".card").hide();
			
					$(".btn-ststs").removeClass('active');
					$('.btn-ststs[data-id="4"]').addClass("active");
