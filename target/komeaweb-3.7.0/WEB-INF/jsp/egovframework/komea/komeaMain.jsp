								...
								<div class="container">
										<div class="row justify-content-center">
												<div class="col-12">
														...
														<div class="hero-slides-content" data-animation="fadeInUp" data-delay="100ms">
																<h2 data-animation="fadeInUp" data-delay="500ms">Korea Marine Equipment Association</h2>
																<p data-animation="fadeInUp" data-delay="700ms">To promoete the developent of marine equipment industries.</p>
																<!--<a href="#" class="btn palatin-btn mt-50" data-animation="fadeInUp" data-delay="900ms">Read More</a>-->
														</div>
												</div>
										</div>
								...
								<div class="container">
										<div class="row justify-content-center">
												<div class="col-12">
														...
														<div class="hero-slides-content" data-animation="fadeInUp" data-delay="100ms">
																<h2 data-animation="fadeInUp" data-delay="500ms">Korea Marine Equipment Association</h2>
																<p data-animation="fadeInUp" data-delay="700ms">Establishing a fair & efficient business environment.</p>
																<!--<a href="#" class="btn palatin-btn mt-50" data-animation="fadeInUp" data-delay="900ms">Read More</a>-->
														</div>
												</div>
										</div>
					...
					<div class="tab-content" id="myTabContent">
							...
							<div class="row no-margin">
												...
												<div class="single-blog-post mb-50" >
													<div class="post-content">
															...
															<div class="post-meta text-center">
																<i class="fa fa-clock" aria-hidden="true"></i><c:out value="${B001List.indate}" />
																<i class="fa fa-user" aria-hidden="true"></i><c:out value="${B001List.uName}" />
															</div>
													</div>
												</div>
											</div>
								...
								<div class="col-12">
									<div class="load-more-btn text-center wow fadeInUp" data-wow-delay="700ms" style="visibility: visible; animation-delay: 700ms; animation-name: fadeInUp;">
										<a href="/komea/bbs/List.do?bCode=B001" class="btn mre-btn"></a>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="row no-margin">
								...
								<div class="col-12">
									<div class="load-more-btn text-center fadeInUp" data-wow-delay="700ms" style="visibility: visible; animation-delay: 700ms; animation-name: fadeInUp;">
										<a href="/show/DisplayList.do" class="btn mre-btn"></a>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="tab-pane fade" id="tab3" role="tabpanel" aria-labelledby="tab--3">
							<div class="row no-margin">
											...
											<c:otherwise>
												...
												<div class="single-blog-post mb-50" >
													<div class="post-content">
														...
														<div class="post-meta text-center">
															<i class="fa fa-clock" aria-hidden="true"></i><c:out value="${B003List.indate}" />
															<i class="fa fa-user" aria-hidden="true"></i><c:out value="${B003List.uName}" />
														</div>
													</div>
												</div>
											</div>
								...
								<div class="col-12">
									<div class="load-more-btn text-center fadeInUp" data-wow-delay="700ms" style="visibility: visible; animation-delay: 700ms; animation-name: fadeInUp;">
										<a href="/komea/bbs/List.do?bCode=B009" class="btn mre-btn"></a>
									</div>
								</div>
							</div>
						</div>
						<div class="tab-pane fade" id="tab4" role="tabpanel" aria-labelledby="tab--4">
							<div class="row no-margin justify-content-center">
											...
											<c:otherwise>
												...
												<div class="single-blog-post mb-50" >
													<div class="post-content">
														...
														<div class="post-meta text-center">
															<i class="fa fa-clock" aria-hidden="true"></i><c:out value="${B004List.indate}" />
															<i class="fa fa-user" aria-hidden="true"></i><c:out value="${B004List.uName}" />
														</div>
													</div>
												</div>
											</div>
								...
								<div class="col-12">
									<div class="load-more-btn text-center fadeInUp" data-wow-delay="700ms" style="visibility: visible; animation-delay: 700ms; animation-name: fadeInUp;">
										<a href="/komea/bbs/List.do?bCode=B010" class="btn mre-btn"></a>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row">
								...
								<div class="col-12 col-md-6 col-lg-6">
										<div class="grid-rooms-area wow fadeInUp" data-wow-delay="100ms">
												...
												<!-- Rooms Text -->
												<div class="grid-text grid-text-bg-blue" >
										...
										<div class="grid-rooms-area wow fadeInUp" data-wow-delay="200ms">
												...
												<div class="grid-text grid-text-bg-blue" >
														...
														<p class="grid-text-p-left-100">
															<a href="/komea/mn0101.do">한국조선해양기자재공업<br class="d-none d-xl-block">협동조합의 비전, 연혁, <br class="d-none d-xl-block">조직도 및 오시는길을 <br class="d-none d-xl-block">안내해드립니다.</a>
														</p>
												</div>
										</div>
								</div>
								...
								<div class="tab-panes col-12 col-md-6 col-lg-3">
										<div class="grid-rooms-area wow fadeInUp" data-wow-delay="100ms">
												...
												<!-- Rooms Text -->
												<div class="grid-text grid-text-bg-blue" style=" cursor: pointer;" onClick="location.href='/komea/mn0301.do';" >
														<h4 class="grid-text-h4-2">사업소개</h4>
														<p class="grid-text-p-left-100">
															<a href="/komea/mn0301.do">Global Ocean Business를 앞장서는 한국조선해양 기자재공업협동조합에서 진행하는 사업을 안내합니다.</a>
														</p>
												</div>
										</div>
								</div>
								...
								<div class="col-12 col-md-6 col-lg-3 lpadding">
										<div class="grid-rooms-area wow fadeInUp" data-wow-delay="200ms">
												...
												<!-- Rooms Text -->
												<div class="grid-text grid-text-bg-blue" >
														<p class="grid-text-p-left-100"><a href="http://komea.webidas.co.kr/" target="_blank">기자재 수요예측 시스템</a></p>
														<P class="grid-text-p-left-100"><a href="http://shipsol.honorgy.co.kr/" target="_blank">수출 및 A/S 시스템</a></P>
												</div>
										</div>
								</div>
								...
								<div class="col-12 col-md-6 col-lg-6 lpadding">
										<div class="grid-rooms-area wow fadeInUp" data-wow-delay="300ms">
												...
												<!-- Rooms Text -->
												<div class="grid-text grid-text-bg-green" >
				 		...
				 		<div class="container" >
							<div class="row">
													...
													<div class="grid-event-area">
															...
															<div class="grid-text ">
																	...
																	<div class="event-info text-left">
																		<h6 class="text-danger text-center"><c:out value="${ExbiInfo.exbiNm}" /></h6>
																		주최 : <c:out value="${ExbiInfo.insttNm}" /><br>
																		<fmt:parseDate value="${ExbiInfo.opmtBeginDe}" var="fromDate" pattern="yyyyMMdd"/>
																		<fmt:parseDate value="${ExbiInfo.opmtClosDe}" var="closeDate" pattern="yyyyMMdd"/>
																		기간 : <fmt:formatDate value="${fromDate}" pattern="yyyy.MM.dd"/> ~ <fmt:formatDate value="${closeDate}" pattern="yyyy.MM.dd"/><br>
																		장소 : <c:out value="${ExbiInfo.opmtPlace}" /></div>
															</div>
											...
											<div class="event-banner col-md-4 col-lg-4">
													<div class="grid-event-area">
															...
															<div class="grid-text-1">
																	<a href="/show/ShowList.do"><h5>마린엑스포</h5></a>
																	<div class="event-info-1 text-left">
																		마린엑스포에서는 한국조선해양기자재공업협동조합의 지난행사보기, 해외바이어리스트와 회원사목록을 확인하실 수 있습니다.<br /><br />
																	</div>
															</div>
													</div>
											</div>
											<div class="event-banner col-md-4 col-lg-4">
													<div class="grid-event-area">
															...
															<div class="grid-text">
																	...
																	<div class="event-info text-left">
																		<h6 class="text-danger text-center"><c:out value="${CnsltInfo.eventNm}" /></h6>
																		주최 : <c:out value="${CnsltInfo.insttNm}" /><br>
																		<fmt:parseDate value="${CnsltInfo.eventBeginDe}" var="fromDate" pattern="yyyyMMdd"/>
																		<fmt:parseDate value="${CnsltInfo.eventClosDe}" var="closeDate" pattern="yyyyMMdd"/>
																		기간 : <fmt:formatDate value="${fromDate}" pattern="yyyy.MM.dd"/> ~ <fmt:formatDate value="${closeDate}" pattern="yyyy.MM.dd"/><br>
																		장소 : <c:out value="${CnsltInfo.place}" />
																	</div>
															</div>
													</div>
											</div>
								...
								<div class="col-lg-2 text-right">
									...
									<div class="apply_b">
										<a href="/komea/bbs/QnaList.do" ><img src="/img/core-img/btn2.png"></a>
									</div>
								</div>
