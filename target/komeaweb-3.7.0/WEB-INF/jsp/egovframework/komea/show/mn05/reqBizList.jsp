											...
											<tr>
												...
												<td class="text-center td-hide-md ">
													...
													<c:when test="${resultList.slctnTypeNm eq '완료'}">
														<span class="btn btn-xs btn-primary rounded-1" style="cursor:default;" >${resultList.slctnTypeNm}</span>
													</c:when>
													<c:when test="${resultList.slctnTypeNm eq '진행'}">
														<span class="btn btn-xs btn-success rounded-1" style="cursor:default;" >${resultList.slctnTypeNm}</span>
													</c:when>
													<c:when test="${resultList.slctnTypeNm eq '선정'}">
														<span class="btn btn-xs btn-info rounded-1" style="cursor:default;" >${resultList.slctnTypeNm}</span>
													</c:when>
													<c:otherwise>
														<span class="btn btn-xs btn-secondary rounded-1" style="cursor:default;" >${resultList.slctnTypeNm}</span>
													</c:otherwise>
													</c:choose>
												</td>
												<td class="text-center td-hide-md">
