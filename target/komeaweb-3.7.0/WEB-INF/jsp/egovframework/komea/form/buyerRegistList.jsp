	...
	<div class="popup-dialog" >
		<div class="popup-content">
			...
			<div class="popup-body">
				...
				<div class="table-responsive mt-10 bo-l" >
					 <!-- table class="table table-bordered border-top-3 text-nowrap table-hover" summary="바이어목록 입니다." -->
					 <table class="table table-bordered border-top-3 table-hover" summary="바이어목록 입니다." >
				 		<caption class="d-none" >바이어검색</caption>
						<thead>
							<tr>
								<th width="25%"><strong>국가</strong></th>
								<th width="25%" class="td-b-hide-sm" ><strong>업체명</strong></th>
								<th width="25%" class="td-hide-md"><strong>구분</strong></th>
