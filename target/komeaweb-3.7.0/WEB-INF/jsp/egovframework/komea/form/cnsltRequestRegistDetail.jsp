...
<div class="section-text col-12 mb-30 bo-v" >
	...
	<h5 class=""><i class="fas fa-align-justify text-info"></i> 상담행사 참가신청서</h5>
	...
	<div class="container mb-10">
		...
		<div class="bo-v-row row">
			...
			<div class="col-md-10"><c:out value="${MainPrduct}" escapeXml="false" /></div>
		</div>
		<div class="bo-v-row row">
			<div class="col-md-2 fth">기본제품(영문)<span class="required"></span></div>
			<div class="col-md-10"><c:out value="${MainPrductEng}" escapeXml="false" /></div>
		</div>
		<div class="bo-v-row row">
			<div class="col-md-2 fth">추가제품(국문)<span class="required"></span></div>
			<div class="col-md-10"><c:out value="${AddPrduct}" escapeXml="false" /></div>
		</div>
		<div class="bo-v-row row">
			<div class="col-md-2 fth">추가제품(영문)<span class="required"></span></div>
			<div class="col-md-10"><c:out value="${AddPrductEng}" escapeXml="false" /></div>
		</div>
		<div class="bo-v-row row">
			<div class="col-md-2 fth">특허/인증(국문)<span class="required"></span></div>
			<div class="col-md-10"><c:out value="${PatentCrtfc}" escapeXml="false" /></div>
		</div>
		<div class="bo-v-row row">
			<div class="col-md-2 fth">특허/인증(영문)<span class="required"></span></div>
			<div class="col-md-10"><c:out value="${PatentCrtfcEng}" escapeXml="false" /></div>
		</div>
		<div class="bo-v-row row">
			<div class="col-md-2 fth">주요거래처(국문)<span class="required"></span></div>
			<div class="col-md-10"><c:out value="${MainBcnc}" escapeXml="false" /></div>
		</div>
		<div class="bo-v-row row">
			<div class="col-md-2 fth">주요거래처(영문)<span class="required"></span></div>
			<div class="col-md-10"><c:out value="${MainBcncEng}" escapeXml="false" /></div>
		</div>
		<div class="bo-v-row row">
			<div class="col-md-2 fth">상담신청 바이어<span class="required"></span></div>
			<div class="col-md-10">
			<c:choose>
