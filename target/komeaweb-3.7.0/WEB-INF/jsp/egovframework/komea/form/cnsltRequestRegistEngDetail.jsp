...
<div class="section-text col-12 mb-30 bo-v" id="printArea">
	...
	<div class="container mb-10">
		...
		<div class="bo-v-row row">
			...
			<div class="col-md-10 no-padding">
				<div class="container">
					<div class="bo-v-row row">
						<div class="col-md-5 no-b-border">
							<c:choose>
								<c:when test="${CnsltCompReqInfo.basicProductFileCours ne ''}">
									<img src="${CnsltCompReqInfo.basicProductFileCours}" alt="${CnsltCompReqInfo.basicProductFileNm}" border="0" class="w-100" />
								</c:when>
								<c:otherwise>
								 	&nbsp;
								</c:otherwise>
						...
						<div class="col-md-7 no-b-border">
							${MainPrductEng}
						</div>
					</div>
				</div>
			...
			<div class="col-md-10 no-padding">
				<div class="container">
					<div class="bo-v-row row">
						<div class="col-md-5 no-b-border">
							<c:choose>
								<c:when test="${CnsltCompReqInfo.addProductFileCours  ne ''}">
									<img src="${CnsltCompReqInfo.addProductFileCours}" alt="${CnsltCompReqInfo.addProductFileNm}" border="0" class="w-100" />
								</c:when>
								<c:otherwise>
								 	&nbsp;
								</c:otherwise>
