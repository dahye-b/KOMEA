...
<body>
	<table border="1" cellspacing="0" cellpadding="0" style="border:1px solid #000000;">
		<tr>
			<td align="center" colspan="5" style="background:#F0F0F0;"><h3>회원사 목록</h3></td>
		</tr>
		<tr>
			...
			<c:choose>
				<c:when test="${fn:length(resultList) > 0}">
					...
					<tr>
						...
						<td align="center"><c:out value="${resultList.homepage}" /></td>
				...
				<c:otherwise>
					<tr>
						<td align="center" colspan="6">조회된 결과가 없습니다.</td>
					</tr>
				</c:otherwise>
			</c:choose>
