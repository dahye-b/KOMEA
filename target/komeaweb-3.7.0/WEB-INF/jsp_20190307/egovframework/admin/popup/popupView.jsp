...
function fn_Edit(){
	document.Form.action = "<c:url value='/admin/popupView.do'/>";
	document.Form.submit();
}
function fn_Delete(){
	document.Form.action = "<c:url value='/admin/DeletePopup.do'/>";
	document.Form.submit();
}
</script>
...
<form:input type="text" path="popupNo" name="popupNo" id="popupNo" value="${popupVO.popupNo}"/>
<div class="content">
<div class="container_fluid">
	    ...
	    <div class="clearfix my-3" >
	        <div class="btn-group btn-group-justified float-right">
	            ...
	            <a href="<c:url value='/admin/popupEdit.do'/>" class="btn btn-sm btn-primary text-white" >수정</a>
