		...
		<div class="bo-w-row row">
			...
			<div class="col-md-10">
				...
				<c:if test="${show.floorPlanFileNm != null}">
					<a href="javascript:fn_downloadFile('${show.floorPlanPath}','${show.floorPlanFileNm}');" title="<c:out value="${show.floorPlanFileNm}" />" ><i class="fas fa-paperclip text-info"></i> <c:out value="${show.floorPlanFileNm}" /></a>
				</c:if>
			</div>
		</div>
