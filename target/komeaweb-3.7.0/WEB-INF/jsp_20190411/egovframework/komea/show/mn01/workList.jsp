...
function detail(obj1, obj2){
	...
	document.ListForm.action = "<c:url value='/show/WorkView.do'/>";
	document.ListForm.submit();
}
function fn_egov_link_page(pageNo){
	document.ListForm.pageIndex.value = pageNo;
	document.ListForm.action = "<c:url value='/show/WorkList.do'/>";
	document.ListForm.submit();
}
function fn_Search(){
	document.ListForm.action = "<c:url value='/show/WorkList.do'/>";
            ...
            <div class="row">
            	...
            	<div class="section-text col-12 mb-100 bo-l">
					...
					<div class="table-responsive text-nowrap">
						 <table class="table table-bordered border-top-3 table-hover" summary="지난행사보기 게시판 입니다." >
					 		<caption class="d-none" >지난행사보기</caption>
							<thead>
								<tr>
									<th width="5%" class="td-hide-md"><strong>번호</strong></th>
									<th width="30%" class="td-b-hide-sm"><strong>행사내용</strong></th>
									<th width="20%" class="td-hide-md"><strong>장소</strong></th>
									<th width="20%" class="td-hide-sm td-b-hide-md"><strong>행사기간</strong></th>
									<th width="25%" class="td-hide-md"><strong>지원기관</strong></th>
								</tr>
							</thead>
							<tbody>
								<c:choose>
