...
<div class="bo-w-row row">
	...
	<div class="col-md-4">
		<form:input type="text" path="id" id="id" name="id" class="form-control input-sm" value="" readonly="true"/>
	</div>
	<div class="col-md-2 fth">
...
<div class="bo-w-row row">
	...
	<div class="col-md-4">
		<form:input type="text" path="postCode1" id="postCode1" name="postCode1" class="form-control input-sm" value=""/> - 
		<form:input type="text" path="postCode2" id="postCode2" name="postCode2" class="form-control input-sm" value=""/>
	</div>
	<div class="col-md-2 fth">
...
<div class="bo-w-row border-top-1 row">
	...
	<div class="col-md-10">
		<textarea class="form-control form-control-sm" name="mainSkll" id="mainSkll" rows="3">${MainSkll}</textarea>
	</div>
</div>
<div class="bo-w-row row">
	<div class="col-md-2 fth">
...
<div class="bo-w-row row">
	...
	<div class="col-md-10">
		<input type="file" name="bsnmRsctftFileNm" id="bsnmRsctftFileNm"/>
	</div>
</div>
<div class="bo-w-row row">
	<div class="col-md-2 fth">
	...
	<div class="col-md-10">
		<input type="file" name="biddingFileNm" id="biddingFileNm"/>
...
<div class="bo-w-row row">
	...
	<div class="col-md-10">
		<input type="file" name="etcFileNm" id="etcFileNm"/>
	</div>
</div>
