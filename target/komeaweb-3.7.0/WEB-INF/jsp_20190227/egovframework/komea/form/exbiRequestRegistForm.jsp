...
<form:input type="hidden" path="insttMberCd" name="insttMberCd" id="insttMberCd" value=""/>
		...
		<div class="bo-w-row row">
			...
			<div class="col-md-10">
				<form:input type="text" path="cmpnyNm" id="cmpnyNm" name="cmpnyNm" class="form-control" value="${LoginUser.cmpnyNm}" />
			</div>
		</div>
		...
		<div class="bo-w-row row">
			...
			<div class="col-md-4">
				<form:input type="text" path="rprsntv" id="rprsntv" name="rprsntv" class="form-control" value="${LoginUser.rprsntv}" />
			</div>
			<div class="col-md-2 fth">
				<label for="chargerDeptEng" class="col-form-label required">사업자등록번호</label>
			</div>
			<div class="col-md-4">
				<form:input type="text" path="bizNum" id="bizNum" name="bizNum" class="form-control" value="${LoginUser.bizNum}" onkeydown="invalidNumChk(this)" />
			</div>
		</div>
		...
		<div class="bo-w-row row">
			...
			<div class="col-md-4">
				<form:input type="text" path="locplc" id="locplc" name="locplc" class="form-control" value="${LoginUser.locplc}" />
			</div>
			<div class="col-md-2 fth">
		...
		<div class="bo-w-row row">
			...
			<div class="col-md-4">
				<form:input type="text" path="emplyCo" id="emplyCo" name="emplyCo" class="form-control w-50" value="${LoginUser.emplyCo}" onkeydown="invalidNumChk(this)" />
			</div>
			<div class="col-md-2 fth">
				<label for="chargerDeptEng" class="col-form-label required">홈페이지</label>
			</div>
			<div class="col-md-4">
				<form:input type="text" path="hmpg" id="hmpg" name="hmpg" class="form-control" value="${LoginUser.hmpg}" />
			</div>
		</div>
		...
		<div class="bo-w-row row">
			...
			<div class="col-md-4">
				<form:input type="text" path="chargerNm" id="chargerNm" name="chargerNm" class="form-control" value="${LoginUser.chargerNm}" />
			</div>
			<div class="col-md-2 fth">
				<label for="chargerDeptEng" class="col-form-label required">담당자 부서/직위</label>
			</div>
			<div class="col-md-4">
				<form:input type="text" path="chargerDept" id="chargerDept" name="chargerDept" class="form-control" value="${LoginUser.chargerDept}" />
			</div>
		</div>
		...
		<div class="bo-w-row row">
			...
			<div class="col-md-4">
				<form:input type="text" path="chargerTlphon" id="chargerTlphon" name="chargerTlphon" class="form-control" value="${LoginUser.chargerTlphon}" />
			</div>
			<div class="col-md-2 fth">
				<label for="chargerDeptEng" class="col-form-label required">팩스</label>
			</div>
			<div class="col-md-4">
				<form:input type="text" path="fax" id="fax" name="fax" class="form-control" value="${LoginUser.fax}" />
			</div>
		</div>
		...
		<div class="bo-w-row row">
			...
			<div class="col-md-4">
				<form:input type="text" path="chargerEmail" id="chargerEmail" name="chargerEmail" class="form-control" value="${LoginUser.chargerEmail}" />
			</div>
			<div class="col-md-2 fth">
			...
			<div class="col-md-4">
				<div class="form-row pl-5 pr-5">
					<div class="form-group no-margin w-50">
						<form:input type="text" path="capl" id="capl" name="capl" class="form-control" value="${ExbiCompReq.capl}" onkeydown="invalidNumChk(this)" />
					</div>
