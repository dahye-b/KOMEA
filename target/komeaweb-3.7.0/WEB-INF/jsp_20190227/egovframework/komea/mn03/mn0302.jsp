...
<p class="py-20"><br />
						 ...
						 <tr>
							 <td ><p>∙  조합보(KME  Magazine)</p>
															 <p>∙  뉴스레터(주간)</p>
														 <p>∙ 이슈대응  특보판(MEK  Magazine)</p></td>
						 </tr>
						 <tr>
							 <td ><p class="text-info">KOMEA FORUM 개최</p></td>
							 <td class="text-left "><p>*  최신 동향 파악/정보  획득 기회</p>
														 <p>*  관련 세미나 무료 초청 등</p></td>
							 </tr>
						 <tr>
							 <td class="bg-light"><strong>기타</strong></td>
							 <td rowspan="2" class="text-left "><p>*  정책 동향 파악 및 의견 건의 등</p></td>
							 </tr>
						 <tr>
							 <td ><p>∙  정부 및 업계인사  초청 </p>
														 <p>  간담회 개최 등</p></td>
