...
function fn_Edit(){
	document.Form.action = "<c:url value='/admin/codeView.do'/>";
	document.Form.submit();
}
function fn_Delete(){
	document.Form.action = "<c:url value='/admin/DeleteCode.do'/>";
	document.Form.submit();
}
</script>
...
<form:input type="text" path="cdDec" name="cdDec" id="cdDec" value="${codeVO.cdDec}"/>
<div class="content">
<div class="container_fluid">
	    ...
	    <div class="clearfix my-3" >
	        <div class="btn-group btn-group-justified float-right">
	            ...
	            <a href="<c:url value='/admin/codeEdit.do'/>" class="btn btn-sm btn-primary text-white" >수정</a>
