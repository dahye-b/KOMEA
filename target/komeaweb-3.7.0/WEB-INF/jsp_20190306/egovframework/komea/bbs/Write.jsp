...
function fn_Insert(){
	document.Form.action = "<c:url value='/komea/bbs/InsertKomeaBoard.do'/>";
	document.Form.submit();
}
</script>
<body>
<form:form name="Form" commandName="bbs" method="post" enctype="multipart/form-data">
	<form:input type="text" path="boardGb" name="boardGb" id="boardGb" value="KomeaBoard"/>
	<form:input type="text" path="bCode" name="bCode" id="bCode" value=""/>
	<form:input type="text" path="idx" name="idx" id="idx" value=""/>
	<form:input type="text" path="block" name="block" id="block" value=""/>
	<form:input type="text" path="rlevel" name="rlevel" id="rlevel" value=""/>
	<form:input type="text" path="boss" name="boss" id="boss" value=""/>
            	...
            	<div class="section-text col-12 mb-100 bo-w">
				    ...
				    <div class="clearfix mb-10" >
				        <div class="btn-group btn-group-justified float-right">
							...
							<a class="btn btn-sm btn-secondary" href="/komea/bbs/List.do?bCode=B007" title="목록" >목록</a>
				        </div>
				    </div>
				    <!-- } 버튼 끝 -->
					...
					<div class="container">
							...
							<div class="bo-w-row row">
								...
								<div class="col-md-10">
									<form:input type="text" path="uName" name="uName" id="uName" value="" class="form-control" placeholder="작성자" />
								</div>
							</div>
							<div class="bo-w-row row">
								<div class="col-md-2 fth" >
							...
							<div class="bo-w-row row">
								...
								<div class="col-md-10">
										<textarea id="ir1" rows="10" cols="20" class="form-control"></textarea>
								</div>
							</div>
