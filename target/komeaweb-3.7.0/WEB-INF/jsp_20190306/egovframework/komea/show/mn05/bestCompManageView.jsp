...
function fn_BuyerInert(obj){
	...
	document.Form.submit();
//window.open('/sub.popup.2.jsp', 'WinPopup', 'status=1,width=600,height=600');
}
//참가업체
        ...
        <div class="container">
            <div class="row">
            	...
            	<div class="section-text col-12 mb-100 bo-v show">
					<jsp:include flush="true" page="/WEB-INF/jsp/egovframework/komea/form/bestCompanyRequestDetail.jsp" />
				    <!-- 버튼 시작 { -->
