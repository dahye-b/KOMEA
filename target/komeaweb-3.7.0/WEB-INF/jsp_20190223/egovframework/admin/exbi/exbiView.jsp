...
<form:form name="Form" commandName="exbi" method="post"> <!-- enctype="multipart/form-data" -->
<form:input type="hidden" path="insertUserId" name="insertUserId" id="insertUserId" value="${loginInfo.id}"/>
<form:input type="hidden" path="exbiCd" name="exbiCd" id="exbiCd" value="${exbiVO.exbiCd}"/>
<div class="content">
<div class="container_fluid">

		<div class="page-header"> 
			<h3>사업관리<small>상세보기</small></h3>
		</div>
