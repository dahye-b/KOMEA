...
<div class="bo-w-row row">
	<div class="col-md-2 fth">
		<label for="rprsntv" class="col-form-label">대표자</label>
	</div>
	<div class="col-md-4">
		<form:input type="text" path="rprsntv" id="rprsntv" name="rprsntv" class="form-control input-sm" placeholder="대표자" value=""/>
	</div>
	<div class="col-md-2 fth">
...
<div class="bo-w-row row">
	...
	<% if(flag.equals("Edit")){ %>
		${mberVO.id}
	<%}else{ %>
		<form:input type="text" path="id" id="id" name="id" class="form-control input-sm" placeholder="사업자등록번호" value="" required="required" />
	<%}%>
...
<div class="bo-w-row row">
	<div class="col-md-2 fth">
		<label for="fondDe" class="col-form-label">설립일자</label>
	</div>
	<div class="col-md-4">
		<form:input type="text" path="fondDe" id="fondDe" name="fondDe" class="form-control input-sm datepicker" placeholder="달력을 선택하세요" value="" OnChange="javascript:fn_DateCheck();"/>
	</div>
	<div class="col-md-2 fth">
		<label for="emplyCo" class="col-form-label">종업원수</label>
	</div>
	<div class="col-md-4">
		<form:input type="text" path="emplyCo" id="emplyCo" name="emplyCo" class="form-control input-sm" placeholder="종업원수" value=""/>
	</div>
</div>

<div class="bo-w-row row">
	<div class="col-md-2 fth">
		<label for="beforeYearSalamt" class="col-form-label">전년도 매출액</label>
	</div>
	<div class="col-md-4">
		<form:input type="text" path="beforeYearSalamt" id="beforeYearSalamt" name="beforeYearSalamt" class="form-control input-sm" placeholder="전년도매출액" value="" maxlength="8"/>
	</div>
	<div class="col-md-2 fth">
		<label for="beforeYearXportAcmslt" class="col-form-label">전년도 수출실적</label>
	</div>
	<div class="col-md-4">
		<form:input type="text" path="beforeYearXportAcmslt" id="beforeYearXportAcmslt" name="beforeYearXportAcmslt" class="form-control input-sm" placeholder="전년도수출실적" value=""/>
	</div>
</div>
...
<div class="bo-w-row row">
	...
	<div class="col-md-4">
		<form:input type="text" path="hmpg" id="hmpg" name="hmpg" class="form-control input-sm" placeholder="051-123-4567" value=""/>
	</div>
	<div class="col-md-2 fth">
		<label for="reprsntEmail" class="col-form-label">이메일</label>
	</div>
	<div class="col-md-4">
		<form:input type="text" path="reprsntEmail" id="reprsntEmail" name="reprsntEmail" class="form-control input-sm" placeholder="051-123-4567" value=""/>
	</div>
</div>
...
<div class="bo-w-row row">
	...
	<div class="col-md-4">
		<form:input type="text" path="chargerNmEng" id="chargerNmEng" name="chargerNmEng" class="form-control input-sm" placeholder="담당자이름 영문" value=""/>
	</div>
</div>
...
<div class="bo-w-row row">
	...
	<div class="col-md-4">
		<form:input type="text" path="chargerDeptEng" id="chargerDeptEng" name="chargerDeptEng" class="form-control input-sm" placeholder="담당자부서 영문" value=""/>
	</div>
</div>
...
<div class="bo-w-row row">
	...
	<div class="col-md-4">
		<form:input type="text" path="chargerOfcps" id="chargerOfcps" name="chargerOfcps" class="form-control input-sm" placeholder="담당자부서" value=""/>
	</div>
	<div class="col-md-2 fth">
		<label for="chargerOfcpsEng" class="col-form-label">담당자직위 영문</label>
	</div>
	<div class="col-md-4">
		<form:input type="text" path="chargerOfcpsEng" id="chargerOfcpsEng" name="chargerOfcpsEng" class="form-control input-sm" placeholder="담당자직위 영문" value=""/>
	</div>
</div>
...
<div class="bo-w-row row">
	...
	<div class="col-md-4">
		<form:input type="text" path="chargerTlphon" id="chargerTlphon" name="chargerTlphon" class="form-control input-sm" placeholder="담당자전화" value="" required="required"/>
	</div>
	<div class="col-md-2 fth">
...
<div class="bo-w-row border-top-1 row">
	<div class="col-md-2 fth">
		<label for="mainPrduct" class="col-form-label">메인제품(국문)</label>
	</div>
	<div class="col-md-10">
...
<div class="bo-w-row row">
	<div class="col-md-2 fth">
		<label for="mainPrductEng" class="col-form-label">메인제품(영문)</label>
	</div>
	<div class="col-md-10">
