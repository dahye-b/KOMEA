            	...
            	<div class="section-text bo-w">
					...
					<div class="container-fluid">
						...
						<div class="bo-w-row row">
							...
							<div class="col-md-4">
								<form:input type="text" path="entrpsNm" id="entrpsNm" name="entrpsNm" class="form-control" placeholder="업체명" value="" required="required" />
							</div>
							<div class="col-md-2 fth">
								<label for="cmpnyNmEng" class="col-form-label required">대표자</label>
							</div>
							<div class="col-md-4">
								<form:input type="text" path="rprsntv" id="rprsntv" name="rprsntv" class="form-control" placeholder="대표자" value="" required="required" />
							</div>
						</div>
							...
							<div class="col-md-10">
								<div class="form-row pl-5 pr-5">
									<div class="form-group no-margin">
										<label class="form-check-label mr-20"><form:radiobutton path="gb" value="Shipowner" checked="yes" /> Shipowner</label>
									</div>
									<div class="form-group no-margin">
									...
									<div class="form-group no-margin ">
										<form:input type="text" path="gbEtcDesc" id="gbEtcDesc" name="gbEtcDesc" class="form-control" placeholder="구분이 Etc 선택시입력하세요" value=""/>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="bo-w-row row">
							...
							<div class="col-md-10">
								<form:input type="text" path="adres" id="adres" name="adres" class="form-control" placeholder="주소" value=""/>
							</div>
						</div>
						...
						<div class="bo-w-row row">
							...
							<div class="col-md-4">
								<form:input type="text" path="cttpc" id="cttpc" name="cttpc" class="form-control" placeholder="연락처" value=""/>
							</div>
							<div class="col-md-2 fth">
								<label for="rprsntvEng" class="col-form-label">종업원</label>
							</div>
							<div class="col-md-4">
								<form:input type="text" path="employeeCn" id="employeeCn" name="employeeCn" class="form-control" placeholder="종업원" value=""/>
							</div>
						</div>
						...
						<div class="bo-w-row row">
							...
							<div class="col-md-4">
								<form:input type="text" path="fax" id="fax" name="fax" class="form-control" placeholder="팩스" value=""/>
							</div>
							<div class="col-md-2 fth">
								<label for="rprsntvEng" class="col-form-label">연간매출액($)</label>
							</div>
							<div class="col-md-4">
								<form:input type="text" path="yearSales" id="yearSales" name="yearSales" class="form-control" placeholder="연간매출액($)" value=""/>
							</div>
						</div>
						...
						<div class="bo-w-row row">
							...
							<div class="col-md-4">
								<form:input type="text" path="hmpg" id="hmpg" name="hmpg" class="form-control" placeholder="홈페이지" value=""/>
							</div>
							<div class="col-md-2 fth">
								<label for="rprsntvEng" class="col-form-label">대표메일</label>
							</div>
							<div class="col-md-4">
								<form:input type="text" path="email" id="email" name="email" class="form-control" placeholder="ex) myname@example.net" value=""/>
							</div>
						</div>
						...
						<div class="bo-w-row row">
							...
							<div class="col-md-4">
								<form:input type="text" path="chargerNm" id="chargerNm" name="chargerNm" class="form-control" placeholder="담당자명" value=""/>
							</div>
							<div class="col-md-2 fth">
								<label for="rprsntvEng" class="col-form-label">담당자연락처</label>
							</div>
							<div class="col-md-4">
								<form:input type="text" path="chargerCttpc" id="chargerCttpc" name="chargerCttpc" class="form-control" placeholder="담당자연락처" value=""/>
							</div>
						</div>
						...
						<div class="bo-w-row row">
							...
							<div class="col-md-4">
								<form:input type="text" path="chargerDept" id="chargerDept" name="chargerDept" class="form-control" placeholder="담당자부서" value=""/>
							</div>
							<div class="col-md-2 fth">
								<label for="rprsntvEng" class="col-form-label">담당자직책</label>
							</div>
							<div class="col-md-4">
								<form:input type="text" path="chargerOfcps" id="chargerOfcps" name="chargerOfcps" class="form-control" placeholder="담당자직책" value=""/>
							</div>
						</div>
						...
						<div class="bo-w-row row">
							...
							<div class="col-md-4">
								<form:input type="text" path="chargerEmail" id="chargerEmail" name="chargerEmail" class="form-control" placeholder="ex) myname@example.net" value=""/>
							</div>
							<div class="col-md-2 fth">
								<label for="rprsntvEng" class="col-form-label">참여행사이력</label>
							</div>
							<div class="col-md-4">
								<form:input type="text" path="partcptnEvent" id="partcptnEvent" name="partcptnEvent" class="form-control" placeholder="참여행사이력" value=""/>
							</div>
						</div>
				    ...
				    <!-- div class="mt-10" >
				        <div class="btn-group btn-group-justified float-right">
							...
							<a class="btn btn-sm btn-secondary" href="sub.8.2.jsp" title="목록" >목록</a>
				        </div>
				    </div -->
