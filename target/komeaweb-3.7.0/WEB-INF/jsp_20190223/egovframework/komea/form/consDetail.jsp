					...
					<div class="mb-30 container" >
								<div class="row" >
									<div class="col-lg-5 text-center">
										...
										<!-- img src="/img/bg-img/bg-1.jpg" class="img-gallery" alt="Gastech 2018" / -->
										<div id="myCarousel" class="carousel slide" data-ride="carousel">
											<div class="carousel-inner">
													<div class="carousel-item active">
														<c:choose>
															<c:when test="${not empty CnsltexhbRegistInfo.cnsltexhbPhotoFileCours1}">
																<img class="d-block w-100" src="<c:out value='${CnsltexhbRegistInfo.cnsltexhbPhotoFileCours1}' />" alt="<c:out value='${CnsltexhbRegistInfo.cnsltexhbPhotoFileNm1}' />">
															</c:when>
															<c:otherwise>
																<img class="d-block w-100" src="/img/core-img/noimg.jpg" alt="No Image">
															</c:otherwise>
														</c:choose>
													</div>
													<div class="carousel-item">
														<c:choose>
															<c:when test="${not empty CnsltexhbRegistInfo.cnsltexhbPhotoFileCours2}">
																<img class="d-block w-100" src="<c:out value='${CnsltexhbRegistInfo.cnsltexhbPhotoFileCours2}' />" alt="<c:out value='${CnsltexhbRegistInfo.cnsltexhbPhotoFileNm2}' />">
															</c:when>
															<c:otherwise>
																<img class="d-block w-100" src="/img/core-img/noimg.jpg" alt="No Image">
															</c:otherwise>
													...
													<div class="carousel-item">
														<c:choose>
															<c:when test="${not empty CnsltexhbRegistInfo.cnsltexhbPhotoFileCours3}">
																<img class="d-block w-100" src="<c:out value='${CnsltexhbRegistInfo.cnsltexhbPhotoFileCours3}' />" alt="<c:out value='${CnsltexhbRegistInfo.cnsltexhbPhotoFileNm3}' />">
															</c:when>
															<c:otherwise>
																<img class="d-block w-100" src="/img/core-img/noimg.jpg" alt="No Image">
															</c:otherwise>
									...
									<div class="col-lg-7">
											...
											<div class="row" >
												...
												<div class="col-sm-6 text-right" >
													<a href="javascript:showAfterResultResearch();" class="btn btn-sm btn-secondary" role="button">행사 통계 분석 보기</a>
												</div>
											</div>
