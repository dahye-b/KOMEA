...
function fn_PreExbiData(obj){
	if(obj != "0"){
		...
		document.Form.preExbiCd.value="";
	}
	document.Form.action = "<c:url value='/show/suppBizManageExbiWrite.do'/>";
	document.Form.submit();
}
//저장
function fn_Save(){
	document.Form.action = "<c:url value='/show/InsertSuppBizManageExbi.do'/>";
	document.Form.submit();
}
</script>
<body>
