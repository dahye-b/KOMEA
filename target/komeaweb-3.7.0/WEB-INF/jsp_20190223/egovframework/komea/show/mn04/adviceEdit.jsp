...
<form:form name="Form" commandName="show" method="post" enctype="multipart/form-data">
	...
	<form:input type="hidden" path="writngTm" name="writngTm" id="writngTm" value=""/>
	<form:input type="hidden" path="etc1" name="etc1" id="etc1" value=""/>
	<form:input type="hidden" path="etc2" name="etc2" id="etc2" value=""/>
	<form:input type="hidden" path="etc3" name="etc3" id="etc3" value=""/>
	<form:input type="hidden" path="etc4" name="etc4" id="etc4" value=""/>
	<form:input type="hidden" path="etc5" name="etc5" id="etc5" value=""/>
