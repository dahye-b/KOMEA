...
<form:form name="ListForm" commandName="show" method="post">
	<form:input type="hidden" path="bbsTy" name="bbsTy" id="bbsTy" value="3"/>
            ...
            <div class="row">
            	...
            	<div class="section-text col-12 mb-100 bo-l">
					...
					<div class="table-responsive text-nowrap">
						 <table class="table table-bordered border-top-3 table-hover" summary="보도자료 게시판 입니다." >
					 		<caption class="d-none" >보도자료</caption>
							<thead>
								<tr>
