...
//	alert(mnCdS.substr(0,4));
	...
	if(mnCd == "mn01"){
		...
		$("#menu1").append("글로벌인증<span class='caret'><i class='fas fa-caret-down'></i></span>");
		$("#menu2").append("${mnNm}<span class='caret'><i class='fas fa-caret-down'></i></span>");
	}else if(mnCd == "mn08"){
		$("#menu1").append("자료실<span class='caret'><i class='fas fa-caret-down'></i></span>");
		$("#menu2").append("${mnNm}<span class='caret'><i class='fas fa-caret-down'></i></span>");
		//메뉴추가.
		if(tmp == "B013" || tmp == "B014"){
			$("#menu2").empty();
			$("#menu2").append("해외 거점 기지 정보<span class='caret'><i class='fas fa-caret-down'></i></span>");
			$("#menu3").append("${mnNm}<span class='caret'><i class='fas fa-caret-down'></i></span>");
		}
					...
					<ul class="dropdown-line">
						...
						<li class="dropdown dropdown-sub-nvi">
							...
							<ul class="dropdown-menu dropdown-menu-ul" role="menu" aria-labelledby="menu1">
								...
								<li role="presentation"><a role="menuitem" tabindex="-1" href="http://komec.devsys.co.kr:8080" target="_blank" >수출 및 A/S시스템</a></li>
						...
						<c:if test="${mnCd eq 'mn06'}">
						<li class="dropdown dropdown-sub-nvi">
							<button type="button" class="btn dropdown-toggle btn-sub-nvi second" id="menu2" data-toggle="dropdown">Mn06<span class="caret"><i class="fas fa-caret-down"></i></span></button>
							<ul class="dropdown-menu dropdown-menu-ul second" role="menu" aria-labelledby="menu1">
								<li role="presentation"><a role="menuitem" tabindex="-1" href="<c:url value='/'/>">수출및a/s 시스템</a></li>
								<li role="presentation"><a role="menuitem" tabindex="-1" href="<c:url value='/'/>">Kosmedia</a></li>
							</ul>
						</li>
						</c:if>
						<c:if test="${mnCd eq 'mn07'}">
						<li class="dropdown dropdown-sub-nvi">
							<button type="button" class="btn dropdown-toggle btn-sub-nvi second" id="menu2" data-toggle="dropdown">Mn07<span class="caret"><i class="fas fa-caret-down"></i></span></button>
							<ul class="dropdown-menu dropdown-menu-ul second" role="menu" aria-labelledby="menu1">
								<li role="presentation"><a role="menuitem" tabindex="-1" href="<c:url value='/komea/mn0701.do'/>">글로벌인증정보</a></li>
								<li role="presentation"><a role="menuitem" tabindex="-1" href="<c:url value='/komea/bbs/List.do?bCode=B015'/>">글로벌인증NEWS</a></li>
							</ul>
						</li>
						</c:if>
						...
						<li class="dropdown dropdown-sub-nvi">
							...
							<ul class="dropdown-menu dropdown-menu-ul second" role="menu" aria-labelledby="menu1">
								...
								<li role="presentation"><a role="menuitem" tabindex="-1" href="<c:url value='/komea/bbs/List.do?bCode=B009'/>">해외 거점 기지 정보</a></li>
								<!--
								<li role="presentation"><a role="menuitem" tabindex="-1" href="<c:url value='/komea/bbs/List.do?bCode=B013'/>">거점기지 산업동향 정보</a></li>
								<li role="presentation"><a role="menuitem" tabindex="-1" href="<c:url value='/komea/bbs/List.do?bCode=B014'/>">거점기지 프로젝트 정보</a></li>
								-->
							</ul>
						</li>
						</c:if>
						...
						<c:if test="${bCode eq 'B013' || bCode eq 'B014'}">
					 	<li class="dropdown dropdown-sub-nvi">
							 <button type="button" class="btn dropdown-toggle btn-sub-nvi second" id="menu3" data-toggle="dropdown">Mn08<span class="caret"><i class="fas fa-caret-down"></i></span></button>
							 <ul class="dropdown-menu dropdown-menu-ul second" role="menu" aria-labelledby="menu1">
								<li role="presentation"><a role="menuitem" tabindex="-1" href="<c:url value='/komea/bbs/List.do?bCode=B013'/>">산업동향 정보</a></li>
								<li role="presentation"><a role="menuitem" tabindex="-1" href="<c:url value='/komea/bbs/List.do?bCode=B014'/>">거점기지 프로젝트 정보 </a></li>
							 </ul>
						 </li>
						</c:if>
