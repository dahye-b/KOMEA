...
<!--								<c:forEach var="a" begin="1" end="${4-fCnt}" step="1">-->
									<tr>
										<th>파일${uploadFileList.fNo}</th>
										<td colspan="3" >
											<input type="file" class="form-control-file" name="file${uploadFileList.fNo}" id="file${uploadFileList.fNo}" placeholder="파일 선택" />
										</td>
									</tr>
<!--								</c:forEach>-->
							</c:forEach>
					...
					<c:forEach var="a" begin="${fCnt+1}" end="4" step="1">
					<tr>
						<th>파일${a}</th>
						<td colspan="3" >
