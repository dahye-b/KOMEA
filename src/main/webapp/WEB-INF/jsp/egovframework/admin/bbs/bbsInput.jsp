...
//	CKEDITOR.replace('editorTextArea');
	...
	CKEDITOR.replace('editorTextArea', {
		filebrowserImageUploadUrl:'/ckeditor/fileUpload.do'
	});
			...
			<table class="table table-form table-sm" >
				...
				<tbody>
					<tr>
						...
						<td colspan="3">
							<form:select class="form-control form-control-sm mr-1" path="bCode">
								...
								<form:option value="B013" label="거점기지 산업동향 정보"/>
								<form:option value="B014" label="거점기지 프로젝트 정보"/>
								<form:option value="B015" label="글로벌인증소식(api)"/>
							</form:select>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<th>파일1</th>
						<td colspan="3" >
							<input type="file" class="form-control-file" name="file1" id="file1" placeholder="파일 선택" onChange="javascript:fn_fileCheck(this)"/>
						</td>
					</tr>
					<tr>
						<th>파일2</th>
