				...
				<tbody>
					...
					<tr>
						...
						<td colspan="3">
							<div class="row">
								<div class="col-5">
									<label class="form-check-label mr-15"><form:radiobutton path="gb" value="Shipowner" /> Shipowner</label>
									<label class="form-check-label mr-15"><form:radiobutton path="gb" value="Shipyard" /> Shipyard</label>
									<label class="form-check-label mr-15"><form:radiobutton path="gb" value="Trading" /> Trading</label>
									<label class="form-check-label"><form:radiobutton path="gb" value="Etc" /> Etc</label>									
								</div>
								<div class="col-7">
