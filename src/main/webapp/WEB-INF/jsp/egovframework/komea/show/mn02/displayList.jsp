            ...
            <div class="row">
            	...
            	<div class="section-text col-12">
						...
						<div class="card search-tabs rounded-0 mb-30">
							...
							<div class="form-inline justify-content-end bo-search mb-10 mt-10 mr-10 ml-10" >
										...
										<div class="col-md-6 no-padding" >
											<div class="div-gallery row" >
												<div class="col-md-5 div-img">
													<c:choose>
														<c:when test="${resultList.exbiPhotoFileNm1 != null}">
															<img src="<c:out value='${resultList.exbiPhotoFilePath1}' />" alt="<c:out value='${resultList.exbiPhotoFileNm1}' />">
														</c:when>
														<c:otherwise>
												...
												<div class="col-md-7 div-content" >
													<h6 class="text-info"><a href="javascript:detail('${resultList.exbiCd}');" class="text-16 text-info"><c:out value="${resultList.exbiNm}" /></a></h6>
													<p>
														<fmt:parseDate value="${resultList.opmtBeginDe}" var="opmtBeginDe" pattern="yyyyMMdd"/>
														<fmt:parseDate value="${resultList.opmtClosDe}" var="opmtClosDe" pattern="yyyyMMdd"/>
														<span class="text-dark">주 최 :</span> <c:out value="${resultList.insttNm}" /><br />
														<span class="text-dark">기 간 :</span> <fmt:formatDate value="${opmtBeginDe}" pattern="yyyy.MM.dd"/> ~ <fmt:formatDate value="${opmtClosDe}" pattern="yyyy.MM.dd"/><br />
