...
<div class="bo-w-row row">
	<div class="col-md-2 fth">
		<label for="chargerNm" class="col-form-label">담당자 이름</label>
	</div>
	<div class="col-md-4">
...
<div class="bo-w-row row">
	...
	<div class="col-md-2 fth">
		<label for="chargerTlphon" class="col-form-label">담당자 연락처</label>
	</div>
	<div class="col-md-4">
...
<div class="bo-w-row row">
	<div class="col-md-2 fth">
		<label for="chargerHp" class="col-form-label">담당자 휴대폰</label>
	</div>
	<div class="col-md-4">
		<form:input type="text" path="chargerHp" id="chargerHp" name="chargerHp" class="form-control input-sm" value="" />
	</div>
	<div class="col-md-2 fth">
		<label for="chargerEmail" class="col-form-label">담당자 이메일</label>
	</div>
	<div class="col-md-4">
...
<div class="bo-w-row border-top-1 row">
	<div class="col-md-2 fth">
		<label for="mainSkll" class="col-form-label">주요업무</label>
	</div>
	<div class="col-md-10">
...
<div class="bo-w-row row">
	...
	<% if(flag.equals("Join")){ %>
		<div class="bo-w-row row">
			<div class="col-md-2 fth">
				<label for="file_nm" class="col-form-label">회사소개서</label>
			</div>
			<div class="col-md-10">
		...
		<div class="bo-w-row row">
			<div class="col-md-2 fth">
				<label for="file_nm2" class="col-form-label">재무제표</label>
			</div>
			<div class="col-md-10">
