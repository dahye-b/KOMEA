							...
							<div class="bo-v-row row">
								...
								<div class="col-md-10 no-padding">
									<div class="container">
										...
										<div class="bo-v-row row">
											<div class="col-md-4 fth no-b-border">참가비 포함사항</div>
											<div class="col-md-8 no-b-border">${ExbiPartcptInclsMatter}</div>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="bo-v-row row">
								...
								<div class="col-md-10 no-padding">
									<div class="container">
										<div class="bo-v-row row">
											<div class="col-md-12">
												<c:if test="${ExbiRegistInfo.attcheFileNm != null}">
													<a href="javascript:fn_downloadFile('${ExbiRegistInfo.attcheFilePath}','${ExbiRegistInfo.attcheFileNm}');" title="<c:out value="${ExbiRegistInfo.attcheFileNm}" />" ><i class="fas fa-paperclip text-info"></i> <c:out value="${ExbiRegistInfo.attcheFileNm}" /></a>
												</c:if>
											</div>
										</div>
										<div class="bo-v-row row">
											<div class="col-md-12">
												<c:if test="${ExbiRegistInfo.attcheFileNm2 != null}">
													<a href="javascript:fn_downloadFile('${ExbiRegistInfo.attcheFilePath2}','${ExbiRegistInfo.attcheFileNm2}');" title="<c:out value="${ExbiRegistInfo.attcheFileNm2}" />" ><i class="fas fa-paperclip text-info"></i> <c:out value="${ExbiRegistInfo.attcheFileNm2}" /></a>
												</c:if>
											</div>
										</div>
										<div class="bo-v-row row">
											<div class="col-md-12 no-b-border">
												<c:if test="${ExbiRegistInfo.attcheFileNm3 != null}">
													<a href="javascript:fn_downloadFile('${ExbiRegistInfo.attcheFilePath3}','${ExbiRegistInfo.attcheFileNm3}');" title="<c:out value="${ExbiRegistInfo.attcheFileNm3}" />" ><i class="fas fa-paperclip text-info"></i> <c:out value="${ExbiRegistInfo.attcheFileNm3}" /></a>
												</c:if>
											</div>
										</div>
									</div>
